...
df_train.to_csv('filelists/train_filelists.csv', index=False, header=True)
df_val.to_csv('filelists/val_filelists.csv', index=False, header=True)
df_test.to_csv('filelists/test_filelists.csv', index=False, header=True)
